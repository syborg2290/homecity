...
class MainPicker extends StatefulWidget {
  final bool isOnlyImage;
  final bool isSingle;
  MainPicker({this.isOnlyImage, this.isSingle, Key key}) : super(key: key);

  @override
  _MainPickerState createState() => _MainPickerState();
}

class _MainPickerState extends State<MainPicker> {
  ...
  getAllItems() async {
    List<AssetPathEntity> list = await PhotoManager.getAssetPathList(
      hasAll: true,
      onlyAll: true,
      type: widget.isOnlyImage ? RequestType.image : RequestType.common,
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: isLoading
          ? Center(child: SpinKitPouringHourglass(color: Pallete.mainAppColor))
