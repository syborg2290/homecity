...
import 'package:nearby/screens/main/fetch&display/places/place_review_replys.dart';
import 'package:nearby/screens/main/fetch&display/places/write_place_review.dart';
...
class PlaceReviewDisplay extends StatefulWidget {
  final String currentUserId;
  final String docId;
  final String id;
  final String placeOwnerId;
  PlaceReviewDisplay(
      {this.currentUserId, this.placeOwnerId, this.docId, this.id, Key key})
      : super(key: key);

  @override
  _PlaceReviewDisplayState createState() => _PlaceReviewDisplayState();
}

class _PlaceReviewDisplayState extends State<PlaceReviewDisplay> {
  ...
  void initState() {
    ...
    _placeService.fetchSinglePlace(widget.id).then((value) {
      DocumentSnapshot doc = value.documents[0];
      Place resturant = Place.fromDocument(doc);
              ...
              onPressed: isLoading
                  ...
                  : () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => WriteReviewPlace(
                                    currentUserId: widget.currentUserId,
                                    id: widget.id,
                                    placeId: widget.docId,
                                    placeOwnerId: widget.placeOwnerId,
          ...
          : StreamBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                ...
                if (snapshot.data.documents == null) {
                  ...
                  Place rest = Place.fromDocument(snapshot.data.documents[0]);
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              AwesomeDialog(
                                ...
                                btnCancelText: 'No',
                                btnOkOnPress: () async {
                                  await placeService.deletePlaceReview(
                                      docId, reviewIndex);
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      await placeService.setReactionToPlaceReview(
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PlaceReviewReplys(
