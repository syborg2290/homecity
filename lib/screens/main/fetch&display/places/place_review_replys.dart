...
class PlaceReviewReplys extends StatefulWidget {
  ...
  @override
  _PlaceReviewReplysState createState() => _PlaceReviewReplysState();
}

class _PlaceReviewReplysState extends State<PlaceReviewReplys> {
  ...
  void initState() {
    ...
    _placeService
        .getAllPlaceReviewReplys(widget.docId, widget.reviewIndex)
        .then((value) {
      setState(() {
        allReplays = value;
      });
  ...
  uploadMediaReply(File upload, String type) async {
    ...
    await _placeService.addReplyToPlaceReview(widget.docId, uploadMedia,
                    ...
                    builder: (BuildContext context, AsyncSnapshot snapshot) {
                      ...
                      if (snapshot.data.documents == null) {
                        ...
                        if (place.reviews != null) {
                          if (place.reviews[widget.reviewIndex]["replys"] !=
                              null) {
                            replys =
                                place.reviews[widget.reviewIndex]["replys"];
                          }
                        }
                    ...
                    GestureDetector(
                      onTap: () async {
                        if (replyController.text.trim() != "") {
                          pr.show();
                          await _placeService.addReplyToPlaceReview(
                              widget.docId,
                              null,
                              widget.currentUserId,
                              widget.reviewIndex,
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              AwesomeDialog(
                                ...
                                btnCancelText: 'No',
                                btnOkOnPress: () async {
                                  await place.deletePlaceReviewReply(
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      await place.setReactionToPlaceReviewReply(
              ...
              Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      await place.setReactionToPlaceReviewReply(docId,
