...
class GrocItemView extends StatefulWidget {
  final grocItem;
  final String docId;
  final String id;
  final int index;
  ...
  @override
  _GrocItemViewState createState() => _GrocItemViewState();
}

class _GrocItemViewState extends State<GrocItemView> {
  List restGallery = [];
  String currentMedia;
            ...
            Container(
              ...
              child: Container(
                ...
                child: InkWell(
                  onTap: () async {
                    QuerySnapshot qSnap =
                        await _grocService.fetchSingleGrocery(widget.id);
                    Grocery restO = Grocery.fromDocument(qSnap.documents[0]);
                    Navigator.push(
                        context,
                        MaterialPageRoute(
