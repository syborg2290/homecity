...
class GrocReviewReplys extends StatefulWidget {
  ...
  @override
  _GrocReviewReplysState createState() => _GrocReviewReplysState();
}

class _GrocReviewReplysState extends State<GrocReviewReplys> {
  ...
  void initState() {
    ...
    _groceryService
        .getAllGrocReviewReplys(widget.docId, widget.reviewIndex)
        .then((value) {
      setState(() {
        allReplays = value;
      });
  ...
  uploadMediaReply(File upload, String type) async {
    ...
    await _groceryService.addReplyToGroceryReview(widget.docId, uploadMedia,
                    ...
                    builder: (BuildContext context, AsyncSnapshot snapshot) {
                      ...
                      if (snapshot.data.documents == null) {
                        ...
                        if (groc.reviews != null) {
                          if (groc.reviews[widget.reviewIndex]["replys"] !=
                              null) {
                            replys = groc.reviews[widget.reviewIndex]["replys"];
                          }
                        }
                    ...
                    GestureDetector(
                      onTap: () async {
                        if (replyController.text.trim() != "") {
                          pr.show();
                          await _groceryService.addReplyToGroceryReview(
                              widget.docId,
                              null,
                              widget.currentUserId,
                              widget.reviewIndex,
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              AwesomeDialog(
                                ...
                                btnCancelText: 'No',
                                btnOkOnPress: () async {
                                  await groc.deleteGroceryReviewReply(
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      await groc.setReactionToGroceryReviewReply(
              ...
              Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      await groc.setReactionToGroceryReviewReply(docId,
