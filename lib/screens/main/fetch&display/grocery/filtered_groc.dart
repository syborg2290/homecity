...
class FilteredGroc extends StatefulWidget {
  final List<Grocery> list;
  final String currentUserId;
  FilteredGroc({this.list, this.currentUserId, Key key}) : super(key: key);

  @override
  _FilteredGrocState createState() => _FilteredGrocState();
}

class _FilteredGrocState extends State<FilteredGroc> {
  BookmarkService _bookmarkService = BookmarkService();
  GroceryService _resturantService = GroceryService();
  List docIds = [];
  bool isLoading = true;
  @override
  void initState() {
    ...
    if (widget.list.isEmpty) {
      ...
      widget.list.forEach((element) {
        _resturantService.fetchSingleGrocery(element.id).then((value) {
          setState(() {
...
class GrocCards extends StatelessWidget {
  final Grocery rest;
  final String docId;
  final int index;
