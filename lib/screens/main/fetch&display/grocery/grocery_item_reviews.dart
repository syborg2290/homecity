...
import 'package:nearby/screens/main/fetch&display/grocery/write_groc_item_reviews.dart';
...
import 'groc_item_review_reply.dart';

class AllGrocItemsReviews extends StatefulWidget {
  ...
  @override
  _AllGrocItemsReviewsState createState() => _AllGrocItemsReviewsState();
}

class _AllGrocItemsReviewsState extends State<AllGrocItemsReviews> {
  ...
  void initState() {
    ...
    _grocService.fetchSingleGrocery(widget.id).then((value) {
      DocumentSnapshot doc = value.documents[0];
      Grocery groc = Grocery.fromDocument(doc);

      setState(() {
        if (json.decode(groc.items[widget.index])["review"] != null) {
          allReviews = json.decode(groc.items[widget.index])["review"];
        }
      });
    });
              ...
              onPressed: isLoading
                  ...
                  : () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => WriteGrocItemReview(
                                    currentUserId: widget.currentUserId,
                                    id: widget.id,
                                    index: widget.index,
                                    grocId: widget.docId,
                                    grocOwnerId: widget.grocOwnerId,
          ...
          : StreamBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                ...
                if (snapshot.data.documents == null) {
                  ...
                  var obj = json.decode(grocery.items[widget.index]);
                  if (obj["review"] != null) {
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              AwesomeDialog(
                                ...
                                btnCancelText: 'No',
                                btnOkOnPress: () async {
                                  await groc.deleteGroceryItemReview(
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      await groc.setReactionsToGroceryItemReview(
              ...
              Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      await groc.setReactionsToGroceryItemReview(indexItem,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => GrocItemReviewReply(
