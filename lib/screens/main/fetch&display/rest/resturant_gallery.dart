...
class ResturantGallery extends StatefulWidget {
  final String currentUserId;
  final String docid;
  final String id;
  final String restOwnerId;
  ResturantGallery(
      {this.currentUserId, this.docid, this.id, this.restOwnerId, Key key})
      : super(key: key);

  @override
  _ResturantGalleryState createState() => _ResturantGalleryState();
}

class _ResturantGalleryState extends State<ResturantGallery> {
  ...
  uploadMediaReply(File upload, String type) async {
    if (type == "image") {
      ...
      await _resturantService.updateResturantGallery(
        widget.docid,
        json.encode(obj),
      );
    } else {
