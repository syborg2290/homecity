...
class FilteredRest extends StatefulWidget {
  final List<Resturant> list;
  final String currentUserId;
  FilteredRest({this.list, this.currentUserId, Key key}) : super(key: key);

  @override
  _FilteredRestState createState() => _FilteredRestState();
}

class _FilteredRestState extends State<FilteredRest> {
  ...
  void initState() {
    ...
    if (widget.list.isEmpty) {
      ...
      widget.list.forEach((element) {
        _resturantService.fetchSingleRest(element.id).then((value) {
          setState(() {
