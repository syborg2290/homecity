...
class WriteReviewRest extends StatefulWidget {
  ...
  @override
  _WriteReviewRestState createState() => _WriteReviewRestState();
}

class _WriteReviewRestState extends State<WriteReviewRest> {
  ...
  videoTrimDialog(String duration, File video, int index) {
    ...
    if (_review.text.trim() != "" || media.isNotEmpty) {
      ...
      await _resturantService.setReviewToResturant(
        widget.restId,
        _review.text.trim(),
        uploadMedia,
