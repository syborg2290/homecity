...
class _RestItemReviewReplyState extends State<RestItemReviewReply> {
  ...
  void initState() {
    ...
    _resturantService
        .getAllReviewReplys(widget.index, widget.docId, widget.reviewIndex)
        .then((value) {
      setState(() {
        allReplays = value;
      });
                ...
                child: FlatButton(
                  onPressed: () async {
                    ...
                    if (trimmedVideo != null) {
                      ...
                      pr.show();
                      await uploadMediaReply(trimmedVideo);
  ...
  uploadMediaReply(File upload) async {
    List uploadMedia = [];
                          ...
                          if (statusRe.isGranted) {
                            ...
                            if (pickedFile != null) {
                              ...
                              if (croppedImage != null) {
                                pr.show();
                                await uploadMediaReply(croppedImage);

                                pr.hide();
                              } else {
                                pr.show();
                                await uploadMediaReply(File(pickedFile.path));
                                pr.hide();
                              }
                            }
                          }
                      ...
                      onTap: () async {
                        ...
                        if (status.isUndetermined) {
                          ...
                          if (statusRe.isGranted) {
                            ...
                            if (pickedFile != null) {
                              String statusRe =
                                  checkVideoDurations(File(pickedFile.path));
                      ...
                      onTap: () async {
                        ...
                        if (obj != null) {
                              ...
                              element.file.then((value) async {
                                if (element.type.toString() ==
                                  ...
                                  if (croppedImage != null) {
                                    ...
                                    pr.show();
                                    await uploadMediaReply(value);

                                    pr.hide();
                                  }
                                } else {
                                  String statusRe = checkVideoDurations(value);
                          ...
                          if (obj["type"] == "camVideo") {
                            String statusRe = checkVideoDurations(
                                File(obj["mediaFile"].path));
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      await rest.setReactionToReviewReply(indexItem, docId,
                          currentUserId, reviewIndex, listIndex, "like");
