...
class AddSportItems extends StatefulWidget {
  final String type;
  final obj;
  AddSportItems({this.type, this.obj, Key key}) : super(key: key);

  @override
  _AddSportItemsState createState() => _AddSportItemsState();
}

class _AddSportItemsState extends State<AddSportItems> {
  File intialImage;
