...
class AddSportsNwellness extends StatefulWidget {
  ...
  @override
  _AddSportsNwellnessState createState() => _AddSportsNwellnessState();
}

class _AddSportsNwellnessState extends State<AddSportsNwellness> {
  File intialImage;
  ...
  double latitude;
  double longitude;
  SportsNwellnessService _sportsNwellnessService = SportsNwellnessService();
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                Text("Creating Sports,wellness & outdoors",
                ...
                if (openController.text != "" && closeController.text != "") {
                  ...
                  if (gallery.isNotEmpty) {
                    for (var ele in gallery) {
                      if (ele["type"] == "image") {
                        String downUrl =
                            await _sportsNwellnessService.uploadImage(
                                await compressImageFile(ele["media"], 80));
                        String thumbUrl =
                            await _sportsNwellnessService.uploadImageThumbnail(
                        ...
                        String downUrl = await _sportsNwellnessService
                            .uploadVideo(await compressVideoFile(ele["media"]));
                        String thumbUrl =
                            await _sportsNwellnessService.uploadVideoToThumb(
                      ...
                      for (var ele in sel["gallery"]) {
                        if (ele["type"] == "image") {
                          String downUrl =
                              await _sportsNwellnessService.uploadImage(
                                  await compressImageFile(ele["media"], 80));
                          String thumbUrl = await _sportsNwellnessService
                          ...
                          String downUrl =
                              await _sportsNwellnessService.uploadVideo(
                  ...
                  String initialImageUpload = await _sportsNwellnessService
                      .uploadImage(await compressImageFile(intialImage, 80));

                  String restId =
                      await _sportsNwellnessService.addSportsNwellness(
                          currentUserId,
                          _name.text.trim(),
                          _aboutThe.text.trim(),
                          initialImageUpload,
            ...
            GestureDetector(
              onTap: () async {
                List reSllingItems = await Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => SportsNWellnessTypes(
                              items: items,
                            )));
              ...
              child: Container(
                  ...
                  child: Center(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Image.asset(
                          'assets/icons/sports_wellness.png',
                          width: 30,
                          height: 30,
