...
import 'package:nearby/screens/main/sub/electronics/view_Rent.dart';
import 'package:nearby/utils/pallete.dart';

import 'add_rent.dart';

class ElecRentTypes extends StatefulWidget {
  final List items;
  ElecRentTypes({this.items, Key key}) : super(key: key);

  @override
  _ElecRentTypesState createState() => _ElecRentTypesState();
}

class _ElecRentTypesState extends State<ElecRentTypes> {
  List items = [];
