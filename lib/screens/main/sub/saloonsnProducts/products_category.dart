...
import 'package:nearby/screens/main/sub/saloonsnProducts/view_products.dart';
import 'package:nearby/utils/pallete.dart';

class ProductsCategory extends StatefulWidget {
  final List items;
  ProductsCategory({this.items, Key key}) : super(key: key);
                ...
                onPressed: () async {
                  if (items.isNotEmpty) {
                    List reItems = await Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ViewBeautyProducts(
                                  items: items,
                                )));
                    if (reItems != null) {
                      setState(() {
            ...
            children: <Widget>[
              ...
              FutureBuilder(
                  future: DefaultAssetBundle.of(context)
                      .loadString("assets/json/beauty_products.json"),
