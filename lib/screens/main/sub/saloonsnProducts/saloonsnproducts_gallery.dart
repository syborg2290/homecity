...
class SaloonsNProductsGallery extends StatefulWidget {
  final List gallery;
  SaloonsNProductsGallery({this.gallery, Key key}) : super(key: key);

  @override
  _SaloonsNProductsGalleryState createState() =>
      _SaloonsNProductsGalleryState();
}

class _SaloonsNProductsGalleryState extends State<SaloonsNProductsGallery> {
  List gallery = [];
