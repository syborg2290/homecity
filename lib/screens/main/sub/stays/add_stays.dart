...
class Addstays extends StatefulWidget {
  Addstays({Key key}) : super(key: key);
...
class _AddstaysState extends State<Addstays> {
  File intialImage;
  TextEditingController _stayName = TextEditingController();
  ...
  StayService _stayService = StayService();
  ProgressDialog pr;
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Center(
                                child: Text(
                              "* Add initial image for the stay",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 23,
            ...
            textBoxContainer(
                _aboutTheStay, "Details", 8, width, false, TextInputType.text),
            SizedBox(
              height: 20,
            ),
            Container(
            ...
            GestureDetector(
              onTap: () async {
                var reObj = await Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => CustomizeStay(
                              obj: customizeObj,
                            )));
                if (reObj != null) {
                  setState(() {
