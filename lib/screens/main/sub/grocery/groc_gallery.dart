...
class GrocGallery extends StatefulWidget {
  final List gallery;
  GrocGallery({this.gallery, Key key}) : super(key: key);

  @override
  _GrocGalleryState createState() => _GrocGalleryState();
}

class _GrocGalleryState extends State<GrocGallery> {
  List gallery = [];
