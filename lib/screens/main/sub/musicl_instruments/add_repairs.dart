...
class AddMusicRepairs extends StatefulWidget {
  final String type;
  final obj;
  AddMusicRepairs({this.type, this.obj, Key key}) : super(key: key);

  @override
  _AddMusicRepairsState createState() => _AddMusicRepairsState();
}

class _AddMusicRepairsState extends State<AddMusicRepairs> {
  File intialImage;
    ...
    if (intialImage != null) {
      if (_itemsOfReparing.text.trim() != "") {
        ...
        GradientSnackBar.showMessage(
            context, "All instruments that reapir is required");
      }
    } else {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            textBoxContainer(_itemsOfReparing, "* All instruments that repair",
                5, width, false, TextInputType.text),
            SizedBox(
              height: 20,
            ),
