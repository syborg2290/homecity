...
class AddHardwareItems extends StatefulWidget {
  final String type;
  final obj;
  AddHardwareItems({this.type, this.obj, Key key}) : super(key: key);

  @override
  _AddHardwareItemsState createState() => _AddHardwareItemsState();
}

class _AddHardwareItemsState extends State<AddHardwareItems> {
  File intialImage;
