...
class HardwareMainCategory extends StatefulWidget {
  final List items;
  HardwareMainCategory({this.items, Key key}) : super(key: key);

  @override
  _HardwareMainCategoryState createState() => _HardwareMainCategoryState();
}

class _HardwareMainCategoryState extends State<HardwareMainCategory> {
  List allItems = [];
              ...
              child: FlatButton(
                onPressed: () async {
                  List reitems = await Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => HardwareItemsView(
                                items: allItems,
                              )));
                  if (reitems != null) {
                    setState(() {
            ...
            children: <Widget>[
              ...
              FutureBuilder(
                  future: DefaultAssetBundle.of(context)
                      .loadString("assets/json/hardware.json"),
