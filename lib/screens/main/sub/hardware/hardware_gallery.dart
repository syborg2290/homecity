...
class HardwareGallery extends StatefulWidget {
  final List gallery;
  HardwareGallery({this.gallery, Key key}) : super(key: key);

  @override
  _HardwareGalleryState createState() => _HardwareGalleryState();
}

class _HardwareGalleryState extends State<HardwareGallery> {
  List gallery = [];
