...
class VocationalTypes extends StatefulWidget {
  final List courses;
  VocationalTypes({this.courses, Key key}) : super(key: key);

  @override
  _VocationalTypesState createState() => _VocationalTypesState();
}

class _VocationalTypesState extends State<VocationalTypes> {
  List courses = [];
  @override
  void initState() {
    super.initState();
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
          future: DefaultAssetBundle.of(context)
              .loadString('assets/json/vocational_Edu.json'),
