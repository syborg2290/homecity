...
class FurnitureNGallery extends StatefulWidget {
  final List gallery;
  FurnitureNGallery({this.gallery, Key key}) : super(key: key);

  @override
  _FurnitureNGalleryState createState() => _FurnitureNGalleryState();
}

class _FurnitureNGalleryState extends State<FurnitureNGallery> {
  List gallery = [];
