...
class GalleryNight extends StatefulWidget {
  final List gallery;
  GalleryNight({this.gallery, Key key}) : super(key: key);

  @override
  _GalleryNightState createState() => _GalleryNightState();
}

class _GalleryNightState extends State<GalleryNight> {
  List gallery = [];
