...
class VehiGallery extends StatefulWidget {
  final List gallery;
  VehiGallery({this.gallery, Key key}) : super(key: key);

  @override
  _VehiGalleryState createState() => _VehiGalleryState();
}

class _VehiGalleryState extends State<VehiGallery> {
  List gallery = [];
