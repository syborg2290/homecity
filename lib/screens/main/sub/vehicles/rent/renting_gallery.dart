...
class RentGallery extends StatefulWidget {
  final List gallery;
  RentGallery({this.gallery,Key key}) : super(key: key);

  @override
  _RentGalleryState createState() => _RentGalleryState();
}

class _RentGalleryState extends State<RentGallery> {
  List gallery = [];
