...
class AddTyre extends StatefulWidget {
  final String type;
  AddTyre({this.type, Key key}) : super(key: key);

  @override
  _AddTyreState createState() => _AddTyreState();
}

class _AddTyreState extends State<AddTyre> {
  File intialImage;
