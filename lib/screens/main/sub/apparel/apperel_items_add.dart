...
class ApparelItems extends StatefulWidget {
  final String mainType;
  final String subType;
  final obj;
  ApparelItems({this.mainType, this.obj, this.subType, Key key})
      : super(key: key);

  @override
  _ApparelItemsState createState() => _ApparelItemsState();
}

class _ApparelItemsState extends State<ApparelItems> {
  File intialImage;
      ...
      if (_itemName.text.trim() != "") {
        if (_price.text.trim() != "") {
          var obj = {
            ...
            "item_maintype": widget.mainType,
            "item_subtype": widget.subType,
