...
class ApparelGallery extends StatefulWidget {
  final List gallery;
  ApparelGallery({this.gallery, Key key}) : super(key: key);

  @override
  _ApparelGalleryState createState() => _ApparelGalleryState();
}

class _ApparelGalleryState extends State<ApparelGallery> {
  List gallery = [];
