...
class AddTailor extends StatefulWidget {
  final String type;
  final obj;
  AddTailor({this.type, this.obj, Key key}) : super(key: key);

  @override
  _AddTailorState createState() => _AddTailorState();
}
  ...
  void initState() {
    ...
    if (intialImage != null) {
      if (_aboutTheItem.text.trim() != "") {
        ...
        GradientSnackBar.showMessage(context, "Item details is required");
      }
    } else {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            textBoxContainer(
                _aboutTheItem, "Details", 3, width, false, TextInputType.text),
            SizedBox(
              height: 20,
            ),
            GestureDetector(
