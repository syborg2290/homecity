...
class AddAnexes extends StatefulWidget {
  final String type;
  AddAnexes({this.type, Key key}) : super(key: key);

  @override
  _AddAnexesState createState() => _AddAnexesState();
}

class _AddAnexesState extends State<AddAnexes> {
  File intialImage;
              ...
              if (_telephone1.text != "" || _telephone2.text != "") {
                if (_price.text.trim() != "") {
                  ...
                  GradientSnackBar.showMessage(
                      context, "Rental fee per month is required");
                }
              } else {
                GradientSnackBar.showMessage(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            textBoxContainer(_propertyDetails, "Annex details ", 8, width,
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  labelText: "* rental fee per month",
                  labelStyle:
