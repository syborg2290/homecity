...
class AddShortTermRoom extends StatefulWidget {
  final String type;
  AddShortTermRoom({this.type, Key key}) : super(key: key);

  @override
  _AddShortTermRoomState createState() => _AddShortTermRoomState();
}

class _AddShortTermRoomState extends State<AddShortTermRoom> {
  File intialImage;
              ...
              if (_telephone1.text != "" || _telephone2.text != "") {
                if (_price.text.trim() != "") {
                  ...
                  if (gallery.isNotEmpty) {
                    for (var ele in gallery) {
                      if (ele["type"] == "image") {
                        ...
                        String downUrl = await _propertyService
                  ...
                  GradientSnackBar.showMessage(
                      context, "Rental fee per hour is required");
                }
              } else {
                GradientSnackBar.showMessage(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            textBoxContainer(_propertyDetails, "Room details ", 8, width, false,
                TextInputType.text),
            SizedBox(
              height: 20,
            ),
