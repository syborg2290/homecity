...
class AddLand extends StatefulWidget {
  final String type;
  AddLand({this.type, Key key}) : super(key: key);
...
class _AddLandState extends State<AddLand> {
  ...
  TextEditingController _pricePerPerch = TextEditingController();
  double latitude;
  double longitude;
                ...
                if (_perches.text.trim() != "") {
                  if (_pricePerPerch.text.trim() != "") {
                    ...
                    GradientSnackBar.showMessage(
                        context, "Price per perch is required");
                  }
                } else {
                  GradientSnackBar.showMessage(
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              width: width * 0.89,
              child: TextField(
                controller: _pricePerPerch,
                keyboardType: TextInputType.number,
                decoration: InputDecoration(
                  labelText: "* Price per perch(LKR)",
                  labelStyle:
                      TextStyle(fontSize: 18, color: Colors.grey.shade500),
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
