...
class AddCommercialProperty extends StatefulWidget {
  final String type;
  AddCommercialProperty({this.type, Key key}) : super(key: key);

  @override
  _AddCommercialPropertyState createState() => _AddCommercialPropertyState();
}

class _AddCommercialPropertyState extends State<AddCommercialProperty> {
  File intialImage;
              ...
              if (_telephone1.text != "" || _telephone2.text != "") {
                if (_size.text.trim() != "") {
                  ...
                  GradientSnackBar.showMessage(
                      context, " Property size is required");
                }
              } else {
                GradientSnackBar.showMessage(
